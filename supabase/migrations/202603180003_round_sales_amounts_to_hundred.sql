-- Redondea montos de ventas al centenar para evitar desfases entre valor mostrado y validado.
...
begin
  ...
  -- Redondeo global al centenar para mantener consistencia en cobro, cambio y reportes.
  v_subtotal := round(v_subtotal / 100) * 100;
  v_discount := round(v_discount / 100) * 100;
  v_iva := round(v_iva / 100) * 100;
